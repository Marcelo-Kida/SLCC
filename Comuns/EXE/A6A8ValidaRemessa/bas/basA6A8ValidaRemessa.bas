...
On Error GoTo ErrorHandler
    ...
    With xmlDOMMensagem.selectSingleNode("/MESG")
        ...
        If Not objDomNode Is Nothing Then
            ...
            ElseIf fgDtXML_To_Date(objDomNode.Text) <> fgDataHoraServidor(enumFormatoDataHora.Data) Then
                'Data da Mensagem inválida
                fgAdicionaErro xmlErrosNegocio, 4060
            End If
        End If
                    ...
                    Case enumTipoMensagemLQS.EventoJurosCETIP, _
                        ...
                        If Not xmlParametroGeral.selectSingleNode("//DIAS_LIMITE_RECEBIMENTO_OPERACAO") Is Nothing Then
                            If xmlParametroGeral.selectSingleNode("//DIAS_LIMITE_RECEBIMENTO_OPERACAO").Text <> vbNullString Then
                                gstrDataRemessa = fgDt_To_Xml(fgDataHoraServidor(DataAux) + Val(xmlParametroGeral.selectSingleNode("//DIAS_LIMITE_RECEBIMENTO_OPERACAO").Text))
                            End If
                        End If
...
On Error GoTo ErrorHandler
    ...
    With xmlDOMRemessa.selectSingleNode("/MESG")
        ...
        datLimiteFech = fgAdicionarDiasUteis(fgDataHoraServidor(enumFormatoDataHora.Data), 1, enumPaginacao.Anterior)
        ...
        If fgDtXML_To_Date(.selectSingleNode("DT_FECH_PROC").Text) < datLimiteFech Or _
           fgDtXML_To_Date(.selectSingleNode("DT_FECH_PROC").Text) > fgDataHoraServidor(enumFormatoDataHora.Data) Then
            '4009 - Data de fechamento inválida
            fgAdicionaErro xmlErrosNegocio, 4009
        End If
...
'    Cas - 18/07/2008
'    =================================================================================================
'    datDataVigencia = fgDataHoraServidor(enumFormatoDataHora.Data)
...
Public Function fgExisteTipoPagamento(ByVal plngTipoPagto As Long) As Boolean
...
On Error GoTo ErrorHandler
    ...
    strSQL = " SELECT   NO_ATRB, CO_DOMI, TP_CNTR_DOMI, DE_DOMI FROM A8.TB_CTRL_DOMI " & _
             " where    CO_DOMI = " & plngTipoPagto
    
    Set rsControleDominio = QuerySQL(strSQL)
    
    With rsControleDominio
        If .RecordCount > 0 Then
            glngTipoPagto = plngTipoPagto
...
On Error GoTo ErrorHandler
    ...
    strSQL = " SELECT   NO_ATRB, CO_DOMI, TP_CNTR_DOMI, DE_DOMI FROM A8.TB_CTRL_DOMI " & _
             " where    CO_DOMI = " & plngTipoPagtoRedesc
...
End Function
'
'Public Sub fgObterControleDominio()
'
'Dim strSQL                                  As String
'
'On Error GoTo ErrorHandler
'
'    If rsControleDominio Is Nothing Then
'        strSQL = " SELECT   NO_ATRB, CO_DOMI, TP_CNTR_DOMI, DE_DOMI FROM A8.TB_CTRL_DOMI "
'        Set rsControleDominio = QuerySQL(strSQL)
'    End If
'
'Exit Sub
'ErrorHandler:
'    If lngCodigoErroNegocio <> 0 Then On Error GoTo 0
'    Call fgRaiseError(App.EXEName, "basA6A8ValidaRemessa", "fgObterControleDominio", lngCodigoErroNegocio, intNumeroSequencialErro)
'
'End Sub
...
On Error GoTo ErrorHandler
    ...
    Select Case plngTipoMensagem
        ...
        Case enumTipoMensagemLQS.ConversaoRedesconto, _
             enumTipoMensagemLQS.RegistroOperacaoBMA
        ...
        Case enumTipoMensagemLQS.TransferenciaLDL_BMA, _
             enumTipoMensagemLQS.LiquidacaoEventosBMA, _
        ...
        Case enumTipoMensagemLQS.ExercicioOpcaoContratoSwapCETIP, _
             enumTipoMensagemLQS.OperacoesComCorretorasCETIP
        ...
        Case enumTipoMensagemLQS.MovimentacoesInstFinancCETIP, _
             enumTipoMensagemLQS.MovimentacoesCustodiaCETIP, _
             ...
             enumTipoMensagemLQS.AntecipacaoResgateContratoDerivativoCETIP, _
       ...
       'Inclusão EnvioTEDClientes = 150 / Complementação 2 = 15/03/07
       ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
       Case enumTipoMensagemLQS.EnvioTEDClientes, _
            enumTipoMensagemLQS.EnvioPagDespesas
    ...
    With xmlDOMMensagem.selectSingleNode("/MESG")
        ...
        If Not objDomNode Is Nothing Then
            ...
            Else
                ...
                Else
                    If fgDtXML_To_Date(objDomNode.Text) <> fgDataHoraServidor(enumFormatoDataHora.Data) Then
                        'Data da operação inválida
                        fgAdicionaErro xmlErrosNegocio, 4024
                    End If
                End If
...
On Error GoTo ErrorHandler
    ...
    With xmlDOMMensagem.selectSingleNode("/MESG")
        ...
        If Not objDomNode Is Nothing Then
            ...
            ElseIf fgDtXML_To_Date(objDomNode.Text) <= fgDataHoraServidor(enumFormatoDataHora.Data) And _
    ...
    With xmlDOMMensagem.selectSingleNode("/MESG")
        ...
        If Not objDomNode Is Nothing Then
            If Not flValidaDataNumerica(objDomNode.Text) Then
                'Data da Mensagem inválida
                fgAdicionaErro xmlErrosNegocio, 4060
            ElseIf fgDtXML_To_Date(objDomNode.Text) >= fgAdicionarDiasUteis(fgDataHoraServidor(enumFormatoDataHora.Data), 2, enumPaginacao.Proximo) Then
                'Data da Mensagem inválida
                fgAdicionaErro xmlErrosNegocio, 4060
            End If
        End If
        ...
        If Not objDomNode Is Nothing Then
            ...
            ElseIf lngTipoMensagem <> enumTipoMensagemLQS.OperacaoRetencaoIRF_CETIP And _
                   ...
                   lngTipoMensagem <> enumTipoMensagemLQS.RegistroContratoTermoCETIP Then
                If Val("0" & objDomNode.Text) <> 0 Then
                    If Not fgExisteProduto(.selectSingleNode("CO_EMPR").Text, _
                                           objDomNode.Text, _
                                           datDataVigencia) Then
                ...
                Else
                    If lngTipoMensagem <> enumTipoMensagemLQS.OperacaoRetencaoIRF_CETIP And _
                        lngTipoMensagem <> enumTipoMensagemLQS.RegistroContratoSWAP Then
                        'Produto inválido
                        fgAdicionaErro xmlErrosNegocio, 4011
                    End If
                End If
        ...
        If Not objDomNode Is Nothing Then
            ...
            ElseIf lngTipoMensagem = enumTipoMensagemLQS.MovimentacoesInstFinancCETIP Then
                ...
                If .selectSingleNode("CO_SUB_TIPO_ATIV").Text = "CFA" And _
                    ...
                    (.selectSingleNode("CO_OPER_CETIP").Text = 1 Or _
                     .selectSingleNode("CO_OPER_CETIP").Text = 101) Then
...
'            End If
        ...
        If Not objDomNode Is Nothing Then
            ...
            If fgDtXML_To_Date(objDomNode.Text) > fgDataHoraServidor(enumFormatoDataHora.Data) And _
            ...
            ElseIf fgDtXML_To_Date(objDomNode.Text) <> fgDataHoraServidor(enumFormatoDataHora.Data) Then
                If lngTipoMensagem = enumTipoMensagemLQS.OperacaoRetencaoIRF_CETIP Or _
                   ...
                   lngTipoMensagem = enumTipoMensagemLQS.AntecipacaoResgateContratoDerivativoCETIP Then
                    ...
                    If lngTipoContraparte = enumTipoContraparte.Cliente1 Then
                        If lngTipoLiquidacao = enumTipoLiquidacao.SemModalidade Then
                            If fgDtXML_To_Date(objDomNode.Text) < fgAdicionarDiasUteis(fgDataHoraServidor(enumFormatoDataHora.Data), 1, enumPaginacao.Anterior) Then
                                'Data de movimento inválida
                                fgAdicionaErro xmlErrosNegocio, 4012
                            End If
                        Else
                ...
                ElseIf lngTipoMensagem = enumTipoMensagemLQS.EventoJurosCETIP Then
                    If fgDtXML_To_Date(objDomNode.Text) > fgAdicionarDiasUteis(fgDataHoraServidor(enumFormatoDataHora.Data), 1, enumPaginacao.Proximo) Then
                        'Data de movimento inválida
                        fgAdicionaErro xmlErrosNegocio, 4012
                    End If
                    ...
                    If lngTipoSolicitacao = enumTipoSolicitacao.Inclusao Or _
                       lngTipoSolicitacao = enumTipoSolicitacao.Complementacao Then
                        ...
                        Else
                            Set objDomNode = .selectSingleNode("TP_CNPT")
                            If Not objDomNode Is Nothing Then
                                If Val("0" & objDomNode.Text) <> enumTipoContraparte.Cliente1 Then
                                    'Tipo Contraparte Inválido.
                                    fgAdicionaErro xmlErrosNegocio, 4182
                                Else
        ...
        If Not objDomNode Is Nothing Then
            ...
            Else
                lngCodigoOperacaoCETIP = objDomNode.Text
            End If
        End If
        ...
        If Not objDomNode Is Nothing Then
            ...
            If lngTipoMensagem = enumTipoMensagemLQS.MovimentacoesCustodiaCETIP Then
                ...
                If .selectSingleNode("CO_OPER_CETIP").Text = enumOperacaoCETIP_CTP0011.RetiradaCustodia Then
            ...
            ElseIf lngTipoMensagem = enumTipoMensagemLQS.MovimentacoesContratoDerivativo Then
                ...
                If .selectSingleNode("CO_OPER_CETIP").Text = enumOperacaoCETIP_CTP9020.CessaoContrato Or _
                   .selectSingleNode("CO_OPER_CETIP").Text = enumOperacaoCETIP_CTP9082.PagamentoIntermediacaoContrato Or _
                   .selectSingleNode("CO_OPER_CETIP").Text = enumOperacaoCETIP_CTP9082.RegistroIntermediacaoContratoSwap Then
                     If Val("0" & Trim$(objDomNode.Text)) = 0 Then
                          'Identificador de contraparte Câmara inválido
                          fgAdicionaErro xmlErrosNegocio, 4139
                     End If
        ...
        If lngTipoSolicitacao <> enumTipoSolicitacao.Inclusao And _
           lngTipoSolicitacao <> enumTipoSolicitacao.Cancelamento Then
            If lngTipoMensagem = enumTipoMensagemLQS.MovimentacoesInstFinancCETIP Then
                ...
                If objTipoOperacao.flVerificarConciliacaoCETIP(xmlDOMMensagem, 0) Then
        ...
        If Not objDomNode Is Nothing Then
            ...
            If UCase$(Trim$(objDomNode.Text)) = "QF" Or _
               UCase$(Trim$(objDomNode.Text)) = "QFF" Then
                objDomNode.Text = "CFA"
            End If
            ...
            Else
                If lngTipoMensagem = enumTipoMensagemLQS.EspecificacaoQuantidadesCotasCETIP Then
                    If Trim$(objDomNode.Text) <> "CFA" Then
                        'SubTipo Ativo inválido
                        fgAdicionaErro xmlErrosNegocio, 4109
                    End If
                Else
                    If Not fgExisteSubTipoAtivo(objDomNode.Text) Then
                        'SubTipo Ativo inválido
                        fgAdicionaErro xmlErrosNegocio, 4109
                    End If
                End If
        ...
        If Not objDomNode Is Nothing Then
            ...
            If lngTipoMensagem = enumTipoMensagemLQS.MovimentacoesContratoDerivativo Then
                If .selectSingleNode("CO_OPER_CETIP").Text = enumOperacaoCETIP_CTP9020.CessaoContrato Or _
                   .selectSingleNode("CO_OPER_CETIP").Text = enumOperacaoCETIP_CTP9082.PagamentoIntermediacaoContrato Or _
                   .selectSingleNode("CO_OPER_CETIP").Text = enumOperacaoCETIP_CTP9082.RegistroIntermediacaoContratoSwap And _
        ...
        If Not objDomNode Is Nothing Then
            If lngTipoMensagem = enumTipoMensagemLQS.MovimentacoesContratoDerivativo And _
                Val(.selectSingleNode("CO_OPER_CETIP").Text) = enumOperacaoCETIP_CTP9020.CessaoContrato And _
                Trim$(objDomNode.Text) = vbNullString Then
        ...
        If lngTipoMensagem = enumTipoMensagemLQS.MovimentacoesContratoDerivativo Then
            ...
            If Not objDomNode Is Nothing Then
                If Val(.selectSingleNode("CO_OPER_CETIP").Text) = enumOperacaoCETIP_CTP9082.PagamentoIntermediacaoContrato Or _
                   Val(.selectSingleNode("CO_OPER_CETIP").Text) = enumOperacaoCETIP_CTP9082.PagamentoIntermediacaoContrato Then
                   If fgVlrXml_To_Decimal(objDomNode.Text) = 0 Then
    ...
    Select Case plngTipoMensagem
        ...
        Case enumTipoMensagemLQS.MovimentacoesCustodiaCETIP
            ...
            ElseIf plngTipoSolicitacao = enumTipoSolicitacao.CancelamentoComMensagem Then
                ...
                fgExisteCodigoOperacaoCETIP = plngCodigoOperacaoCETIP = enumOperacaoCETIP_CTP0100.EstornoDesvinculacaoCalcao Or _
                                              plngCodigoOperacaoCETIP = enumOperacaoCETIP_CTP0100.EstornoRetiradaCustodia Or _
                                              plngCodigoOperacaoCETIP = enumOperacaoCETIP_CTP0100.EstornoCaucao Or _
                                              plngCodigoOperacaoCETIP = enumOperacaoCETIP_CTP0100.EstornoVinculacaoDesvinculacaoContaMargem Or _
                                              plngCodigoOperacaoCETIP = enumOperacaoCETIP_CTP0100.EstornoMovimentacaoGarantiaCamara Or _
                                              plngCodigoOperacaoCETIP = enumOperacaoCETIP_CTP0100.EstornoVinculacaoDesvinculacaoContaMargem Or _
                                              plngCodigoOperacaoCETIP = enumOperacaoCETIP_CTP0100.EstornoTransferenciaCustodiaEntreContasCliente
        ...
        Case enumTipoMensagemLQS.OperacaoCompromissadaCETIP
            ...
            If plngTipoSolicitacao = enumTipoSolicitacao.Inclusao Or _
               plngTipoSolicitacao = enumTipoSolicitacao.Complementacao Or _
               plngTipoSolicitacao = enumTipoSolicitacao.Cancelamento Or _
               plngTipoSolicitacao = enumTipoSolicitacao.CancelamentoPorLastro Then
        ...
        Case enumTipoMensagemLQS.RegistroContratoSWAP
...
On Error GoTo ErrorHandler
    ...
    With xmlDOMMensagem.selectSingleNode("/MESG")
        ...
        If Not objDomNode Is Nothing Then
            ...
            Else
                If Not fgDiaUtil(fgDtXML_To_Date(objDomNode.Text)) Then
                    ...
                    fgAdicionaErro xmlErrosNegocio, 4059
                Else
                    If datTemp < fgDataHoraServidor(enumFormatoDataHora.Data) Then
                        If lngTipoMensagem = enumTipoMensagemLQS.Definitiva Then
                            If datTemp < fgAdicionarDiasUteis(fgDataHoraServidor(enumFormatoDataHora.Data), 1, enumPaginacao.Anterior) Then
                                If datTemp = fgAdicionarDiasUteis(fgDataHoraServidor(enumFormatoDataHora.Data), 2, enumPaginacao.Anterior) Then
        ...
        If datTemp <> fgDataHoraServidor(enumFormatoDataHora.Data) And _
        ...
        ElseIf datTemp > fgDataHoraServidor(enumFormatoDataHora.Data) And _
        ...
        ElseIf datTemp > fgDataHoraServidor(enumFormatoDataHora.Data) And _
            ...
            If datTemp >= fgAdicionarDiasUteis(fgDataHoraServidor(enumFormatoDataHora.Data), 2, enumPaginacao.Proximo) Then
                'Data da operação inválida
                fgAdicionaErro xmlErrosNegocio, 4024
            End If
        ...
        If lngTipoMensagem = enumTipoMensagemLQS.VinculoDesvinculoTransf Then
            ...
            Set objDomNode = .selectSingleNode("TP_TRAF_LDL")
            If Not objDomNode Is Nothing Then
                If lngTipoVinculo = enumTipoVinculo.TransferenciaCamaraLDL And objDomNode.Text = vbNullString Then
        ...
        If lngTipoMensagem = enumTipoMensagemLQS.PgtoRedesconto Then
            ...
            If Not objDomNode Is Nothing Then
                If objDomNode.Text <> vbNullString Then
                    If lngTipoSolicitacao = enumTipoSolicitacao.Complementacao Then
                        If Not fgExisteTipoPagamento(Val("0" & objDomNode.Text)) Then
        ...
        If Not objDomNode Is Nothing Then
            ...
            Else
                ...
                ElseIf fgDtXML_To_Date(objDomNode.Text) > fgDataHoraServidor(Data) Then
