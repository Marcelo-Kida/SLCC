Attribute VB_Name = "basRegistryAPI"

' Este componente tem como objetivo agrupar métodos e declarações públicas referentes ao tratamento
' de operações com o Registry do Windows.
...
'-------------------------------------------------------------------------------------------------
Public Function UpdateKey(KeyRoot As RegKey, KeyName As String, SubKeyName As String, SubKeyValue As String) As Boolean
...
'-------------------------------------------------------------------------------------------------
Public Function GetKeyValue(KeyRoot As RegKey, KeyName As String, SubKeyRef As String) As String
