...
namespace A7NET.Servico
{
    public partial  class A7NETServico : ServiceBase
    {
        A7NET.GerenciadorFila.VerificaFila verificaFilas = null;
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                verificaFilas = new A7NET.GerenciadorFila.VerificaFila();
            ...
            {
                //System.Diagnostics.EventLog.WriteEntry("A7NETServico:OnStart()",
                //                                       "ERRO: " + ex.Message,
        ...
        protected override void OnStop()
        {
            ...
            {
                //System.Diagnostics.EventLog.WriteEntry("A7NETServico:OnStop()",
                //                                       "ERRO: " + ex.Message,
                //                                       EventLogEntryType.Error);
            }
            finally
        ...
        private void WorkerFunction()
        {
            ...
            {
                //System.Diagnostics.EventLog.WriteEntry("A7NETServico:WorkerFunction",
                //                                       "ERRO: " + ex.Message,
                //                                       EventLogEntryType.Error);
