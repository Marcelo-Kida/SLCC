        ...
        public override void ProcessaMensagem(string nomeFila, string mensagemRecebida, string messageId)
        {
            ...
            try
            {
                ...
                if (base.AutenticarMensagem())
                {
                    ...
                    || base._ProtocoloMensagem.SiglaSistemaOrigem.Trim().ToUpper() == "HQ"
                    || base._ProtocoloMensagem.SiglaSistemaOrigem.Trim().ToUpper() == "CMX"
                    ...
                    if (TraduzMensagem)
                    {
                        ...
                        if (base.TraduzirMensagem())
                        {
                            ...
                            if (base._ProtocoloMensagem.SiglaSistemaDestino.Trim().ToUpper() != "A7")
                            {
                                ...
                                || base._ProtocoloMensagem.SiglaSistemaDestino.Trim().ToUpper() == "HQ"
                                || base._ProtocoloMensagem.SiglaSistemaDestino.Trim().ToUpper() == "CMX"
